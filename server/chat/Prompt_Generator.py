...
class PromptGenerator:
    ...
    def generate_system_prompt() -> str:
       system_prompt = f"""
               ...
               - You may provide information about global or web-sourced mental health services if the user requests, 
               but always inform the user that your primary, verified sources are based in Australia.
               ...
               - Plain text only, except for clickable website links using Markdown format.
               - Use Markdown syntax only for the WEBSITE and EMAIL fields, e.g.:
                 WEBSITE: [https://example.com]
                 EMAIL: [foxtrot@gmail.com]
               - No other Markdown, bullets, special symbols, or asterisks.
               ...
               CAVEAT: This information was retrieved from web sources to supplement our database. Please verify details 
